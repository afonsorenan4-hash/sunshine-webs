...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "Dr. Anderson Lima — Tricologia e Transplante Capilar" },
      {
        name: "description",
        content:
      ...
      { property: "og:title", content: "Dr. Anderson Lima — Tricologia e Transplante Capilar" },
      {
        ...
        content:
          "Transplante capilar de alta precisão com resultados naturais. Agende sua avaliação.",
      },
    ...
    links: [
      ...
      {
        rel: "stylesheet",
        href: "https://fonts.googleapis.com/css2?family=Playfair+Display:ital,wght@0,400;0,500;0,700;1,400;1,500&family=Montserrat:wght@300;400;500;600;700&display=swap",
      },
    ],
  }),
